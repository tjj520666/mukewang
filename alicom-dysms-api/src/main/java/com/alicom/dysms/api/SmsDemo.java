...
public class SmsDemo {
    ...
    static final String accessKeyId = "LTAIkpHHVfDxTCUK";
    static final String accessKeySecret = "bkSiDj92PNOyuDK90KMBGPS2MTAt8E";
    //发短信的。
    ...
    public static SendSmsResponse sendSms(String phone , int sms) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("慕课网");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_164385256");
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        request.setTemplateParam("{\"yzm\":" +  sms + " }");
