...
(function(global) {
    ...
    function newContext(contextName) {
        ...
        function makeModuleMap(name, parentModuleMap, isNormalized, applyMap) {
            ...
            originPrefix = prefix = nameParts[0];
            name = nameParts[1];

            prefix = textReg.test(name) ? 'text': undefined;
            ...
            if (name) {
                ...
                } else if (prefix && !originPrefix) {
                    normalizedName = normalize(name, parentName, applyMap);
                    isNormalized = true;
                    url = context.nameToUrl(normalizedName, null, true);
                } else {
                    //A regular module.
                    normalizedName = normalize(name, parentName, applyMap);
        ...
        Module.prototype = {
            ...
            callPlugin: function() {
                ...
                on(pluginMap, 'defined', bind(this, function(plugin) {
                    ...
                    plugin.load(map.name, localRequire, load, config, map.url);
                }));
        ...
        context = {
            ...
            nameToUrl: function(moduleName, ext, skipExt) {
                ...
                if (req.jsExtRegExp.test(moduleName)) {
                    ...
                    url = syms.join('/');
                    url += (ext || (/^data\:|\?/.test(url) || skipExt || (/\.js$/.test(url)) ? '' : '.js'));
