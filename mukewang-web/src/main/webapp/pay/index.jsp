...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="${pageContext.request.contextPath}/pay/alipay.trade.page.pay.jsp" method=post
			target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dt>用户名 ：</dt>
					<dd>
						<input id="" name="WIDsubject" value="${param.name}" readonly/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="" name="WIDtotal_amount"  value="${param.money}" readonly/>
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
